      ...
      <div id="bp3-layout" className="grid text-white bg-blue-900">
        <div id="nav-bar" className="w-full text-2xl py-2">
          <div id="nav-title" className="ml-2">
              ...
              />
              <Link href="/bp3/gettingstarted" className="inline mx-7"><div className="inline hover:scale-105 border p-4">Getting Started</div></Link>
              <Link href="/bp3/modlist" className="inline mx-7">Mod List</Link>
              <Link href="/">
